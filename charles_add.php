...
<body style="background:#f8f8f8;font-family: Calibri;">
 ...
 <div class="col-lg-10 col-md-9 col-sm-9 col-xs-12"> 
    ...
    <div class="row">
      ...
      <div class="panel-heading" style='background:#661515;color:#fff;'>Add New house</div>
    ...
    <option value="acres">Acres</option>
		...
		<!-- <div class="form-group">
		 ...
		 <div class="form-group">
	        <label for="imgg">Image 2</label>
	       
			<input type="file" class="form-control" id="exampleInputFile" name="imagee">
	    </div>
		 <div class="form-group">
	        <label for="imggg">Image 3</label>
	      
		   <input type="file" class="form-control" id="exampleInputFile" name="imageee">
		   
	    </div>
		 <div class="form-group">
	        <label for="imgggg">Image 4</label>
	     
		   <input type="file" class="form-control" id="exampleInputFile" name="imageeee">
	    </div>-->
		 <div class="form-group">
		 ...
		 <div class="form-group">
	        ...
	        <input type="text" class="form-control" id="electri" placeholder="electricity" name="electri" value="">
	    </div>
		 <div class="form-group">
	        <label for="water">Tap Water</label>
	        <input type="text" class="form-control" id="water" placeholder="tap water" name="water" value="">
	    </div>
		 <div class="form-group">
	        <label for="road">Wide Road</label>
	        <input type="text" class="form-control" id="road" placeholder="wide road" name="road" value="">
	    </div>
		<div class="form-group">
