...
$select_ad_table = mysql_query("select * from land where land_id = '$land_id'");
 ...
 <div class="col-lg-10 col-md-9 col-sm-9 col-xs-12"> 
  <div class='row'> 
		...
		<div class='col-lg-2 col-md-2 col-sm-2 col-xs-12'>	
			<h4>&nbsp;</h4>
                <a href="land.php"><h5 style="background:#1e8032; padding:9px; width:80%; color:#fff; text-align:center; border:solid 1px #CCC; border-radius:5px; margin-left:2%;"><i class=""></i>Add</h5></a>
		</div>
		<div class='col-lg-2 col-md-2 col-sm-2 col-xs-12'>		
				 <h4>&nbsp;</h4>
                <a href="land_update_req.php"><h5 style="background:#fc7d0d; padding:9px; width:80%; color:#fff; text-align:center; border:solid 1px #CCC; border-radius:5px; margin-left:2%;"><i class=""></i>Edit</h5></a>
              
			
		</div>
		<div class='col-lg-2 col-md-2 col-sm-2 col-xs-12'>		
				 <h4>&nbsp;</h4>
                <a href="land_delete.php"><h5 style="background:#bb2107; padding:9px; width:80%; color:#fff; text-align:center; border:solid 1px #CCC; border-radius:5px; margin-left:2%;"><i class=""></i>Delete</h5></a>
    ...
    <option value="acres">Acres</option>
	    ...
	    <a href="land_update_req.php" class="btn btn-default" role="button" >Back</a>
