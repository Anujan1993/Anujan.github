 ...
 <div class="col-lg-10 col-md-9 col-sm-9 col-xs-12"> 
  <div class='row'> 
        ...
        <div class='row'>
			...
			<div class='col-lg-3 col-md-3 col-sm-3 col-xs-12'>
				<div style='border:sloid 1px black'>
					<a href="customer_land.php?page=customer_land&id=<?php echo $cat_row['land_id']; ?>">View to Add</a>
				</div>
			</div>
        ...
        <div class='row'>
			...
			<div class='col-lg-3 col-md-3 col-sm-3 col-xs-12'>
				<div style='border:sloid 1px black'>
					<a href="customer_land.php?page=customer_land&id=<?php echo $row['land_id']; ?>"> View to Add</a>
				</div>
			</div>
