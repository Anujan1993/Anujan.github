 ...
 <div class="col-lg-10 col-md-9 col-sm-9 col-xs-12"> 
   <div class='row'> 
    ...
    <div class="row">
      ...
      <div class="panel-heading" style='background:#661515;color:#fff;'>Delete House</div>
	...
	<form action="" method ="POST" enctype="multipart/form-data">
	    ...
	    <div class="form-group">
	        ...
	        <input type="text" class="form-control" id="title" placeholder="Land ID" name="house_id" value="">
	    </div>
