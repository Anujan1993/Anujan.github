...
<div class="container">
    <div class="row">
      ...
      <div class="panel-heading" style='background:#000000 ;color:#fff;'>Add New Land</div>
	...
	<form action="" method ="POST" enctype="multipart/form-data">
	    ...
	    <div class="form-group">
	        ...
	        <input type="text" class="form-control" id="title" placeholder="Land tilte" name="title" value="">
	    </div>
			    <div class="form-group">
    ...
    <option value="acres">Acres</option>
		...
		<div class="form-group">
	        <label for="road3" style="color: green">Add Panaroma Image</label>
	   ...
	   <style>
		...
		if(isset($_POST['submit']))
		{
			...
			if($con=mysqli_connect('localhost','root','','gyr'))
			{
				...
				$filepath= "admin/images/customer/land/pics/".$filename;
				
				$filetemp1= $_FILES['img1']['tmp_name'];
				$filename1= $_FILES['img1']['name'];
				$filetype1= $_FILES['img1']['type'];
				$filepath1= "admin/images/customer/land/pics1/".$filename1;
				
				$filetemp2= $_FILES['img2']['tmp_name'];
				$filename2= $_FILES['img2']['name'];
				$filetype2= $_FILES['img2']['type'];
				$filepath2= "admin/images/customer/land/pics2/".$filename2;
				
				$filetemp3= $_FILES['img3']['tmp_name'];
				$filename3= $_FILES['img3']['name'];
				$filetype3= $_FILES['img3']['type'];
				$filepath3= "admin/images/customer/land/pics3/".$filename3;
				...
				$query = mysqli_query($con,"insert into publish_land(land_title,land_size,land_perches,land_desc,land_price,land_address,land_location,land_city,land_contact,land_state,electricity,tap_water,wide_road,image_name,image_path,image_type,image_name1,image_path1,image_type1,image_name2,image_path2,image_type2,image_name3,image_path3,image_type3,date)values('$title','$size','$land_size','$description','$price','$address','$location','$city','$number','$state','$electri','$water','$road','$filename','$filepath','$filetype','$filename1','$filepath1','$filetype1','$filename2','$filepath2','$filetype2','$filename3','$filepath3','$filetype3',NOW())");
